...
import 'package:promosells_flutter/widgets/my_constant.dart';
import 'package:promosells_flutter/widgets/my_spacing.dart';

// Ported unchanged from AdroitERP's lib/helper/widgets/my_container.dart.
      ...
      decoration: BoxDecoration(
          ...
          borderRadius: enableBorderRadius
              ? (shape == BoxShape.rectangle
                  ? borderRadius ?? BorderRadius.all(Radius.circular(borderRadiusAll ?? MyConstant.constant.containerRadius))
                  : null)
              : null,
